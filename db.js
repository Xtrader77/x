...
export async function loadAllTrades(includeScreenshots = false) {
    ...
    trades.forEach(t => {
        ...
        journals[t.id] = {
            ...
            model: t.model, phase: t.phase, outcome: t.outcome, timestamp: t.timestamp,
...
export async function loadReviews() {
    ...
    // the caller trusts the cloud as authoritative, so a transient network
    // error must not look identical to "you have zero reviews" and wipe
    // out a local cache that was actually fine.
